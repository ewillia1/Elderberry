...
// TODO: MAY NOT USE! May need to delete file.
public class DoseTracker {
    private ArrayList<String> doseArray = new ArrayList<>();

    public DoseTracker() {

    }

    public DoseTracker(ArrayList<String> newArrayList) {
        this.doseArray = newArrayList;
    }

    public ArrayList<String> getDoseArray() {
        return this.doseArray;
    }
...
//
//    public DoseTracker(String dose1, String dose2, String dose3, String dose4, String dose5, String dose6,
